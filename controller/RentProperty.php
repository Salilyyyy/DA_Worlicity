...
class RentPropertyController
{
    ...
    public function index()
    {
        ...
        $result = $this->model->rentPropertiesDistrict($keyword, $district, $propertyType, $price, $bedroom, $bathroom, $utilities, $offset, $limit);

        foreach ($result as $key => $row) {
            $result[$key]['formatted_price'] = $this->formatPrice($row['price']);
        }

        require_once 'view/rent_property/index.php';
    }
